...
export namespace Box2D {
	...
	**/
	export class b2DynamicTreeBroadPhase implements IBroadPhase {
		...
		**/
		public MoveProxy(proxy: b2DynamicTreeNode, aabb: b2AABB, displacement: b2Vec2): void;
	...
	**/
	export interface IBroadPhase {
		...
		* @param displacement Extra AABB displacement.
		**/
		MoveProxy(proxy: b2DynamicTreeNode, aabb: b2AABB, displacement: b2Vec2): void;
	...
	**/
	export class b2PolygonShape extends b2Shape {
		...
		* @return Convex polygon shape.
		**/
		public SetAsArray(vertices: b2Vec2[], vertexCount?: number): void;
	...
	**/
	export class b2World {
		...
		**/
		public QueryAABB(callback: (fixutre: b2Fixture) => boolean, aabb: b2AABB): void;
		...
		**/
		public QueryPoint(callback: (fixture: b2Fixture) => boolean, p: b2Vec2): void;
		...
		**/
		public QueryShape(callback: (fixture: b2Fixture) => boolean, shape: b2Shape, transform?: b2Transform): void;
		...
		**/
		public RayCast(callback: (fixture: b2Fixture, point: b2Vec2, normal: b2Vec2, fraction: number) => number, point1: b2Vec2, point2: b2Vec2): void;
	...
	**/
	export class b2Contact {
		...
		**/
		...
		/**
		* Get the contact manifold. Do not modify the manifold unless you understand the internals of 
	...
	**/
	export class b2PullyJointDef extends b2JointDef {
		...
		* @param anchorB Anchor B.
		**/
		public Initialize(bA: b2Body, bB: b2Body, gaA: b2Vec2, gaB: b2Vec2, anchorA: b2Vec2, anchorB: b2Vec2): void;
	}
