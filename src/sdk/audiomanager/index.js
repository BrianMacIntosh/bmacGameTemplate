...
AudioManager.setListener = function(position)
{
	this.listener = position;
}

//TODO: update volume on frame
AudioManager.updateVolume = function(clip)
{
	//Do ranges
...
AudioManager.preloadSound = function(url)
{
...
AudioManager.playSound = function(url, vol)
{
	// server-side fail silent
	if (typeof Audio === "undefined") return;
